...
class WarmupProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        ...
        # return self._create_examples(self._read_text(os.path.join(data_dir, "merge7/merge7_train.tsv")), "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self._read_text(os.path.join(data_dir, 'valid')), "valid")
        # return self._create_examples(self._read_text(os.path.join(data_dir, "merge7/merge7_valid.tsv")), "dev")
    ...
    def get_unlabeled_examples(self, data_dir):
        ...
        # return self._create_examples(self._read_text(os.path.join(data_dir, "merge7/merge7_test.tsv")), "test")
    ...
    def _create_examples(self, lines, set_type):
        ...
        for i, line in enumerate(lines):
            ...
            for m in range(0, len(context), 2):
                # intent_context = ' '.join(context[: m+1])
